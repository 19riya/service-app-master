...
import com.hrproject.Activities.user.User_Show_Profile;
import com.hrproject.Activities.user.User_Welcome;
import com.hrproject.BuildConfig;
import com.hrproject.ChangeLanguage;
...
public class User_Profile extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        v.findViewById(R.id.user_change_password).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        v.findViewById(R.id.user_change_language).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                changeLanguage();
            }
        ...
        v.findViewById(R.id.logout_user).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                SweetAlertDialog ff=new SweetAlertDialog(getActivity(),SweetAlertDialog.SUCCESS_TYPE);
                ff.setTitleText(getResources().getString(R.string.alert));
                ...
                ff.setConfirmButton(getResources().getString(R.string.ok), new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sweetAlertDialog)
                    {
                        ...
                        ((User_Welcome)getActivity()).finish();
                    }
                });
        ...
        v.findViewById(R.id.myProfileLayout).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                Intent i=new Intent(getActivity(), User_Show_Profile.class);
                startActivity(i);
            }
        });
